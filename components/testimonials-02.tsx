...
export function Testimonials02() {
  return (
    <div className="w-full overflow-x-hidden py-16 bg-gradient-to-b from-slate-50/50 via-white to-slate-50/50 dark:from-slate-950/50 dark:via-slate-900/40 dark:to-slate-950/50">
      {/* Centered Section Header */}
      <div className="max-w-3xl mx-auto text-center px-4 mb-10 flex flex-col items-center justify-center">
        <h2 className="font-bricolage text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight text-slate-900 dark:text-white text-center">
          Loved by devs worldwide
        </h2>

        <p className="pt-3 text-base sm:text-lg text-balance text-slate-600 dark:text-slate-400 text-center">
          See what developers are saying about my work and projects.
        </p>
      </div>

      {/* Centered Moving Marquee Rows with Equal Left & Right Margins */}
