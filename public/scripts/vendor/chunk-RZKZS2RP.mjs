import { o as f } from "chunk-S2QK2XS6.mjs";
...
function d() {
  if (m(window)?.override === "tunnel") return x();
}
var l = { app: "127.0.0.1", canvas: "127.0.0.1", https: !1 },
  u = { app: "localhost", canvas: "localhost", https: !1 },
  g = { app: "web.framerlocal.com", canvas: "web.framerlocal.com", https: !1 },
  D = [
...
function b(t) {
  ...
  let w = f.get("prototypeTreeDriver");
  return (
    n.searchParams.set("experiment", `prototypeTreeDriver=${w}`),
...
function S(t) {
  ...
  let e = window.location,
    { origin: n, isCrossOriginProtected: o } = b(t),
    a = e.hostname === l.app,
    r = e.hostname === u.app,
    i = e.hostname === g.app;
  c(
...
export { d as a, h as b, b as c, S as d, y as e };
//# sourceMappingURL=chunk-RZKZS2RP.mjs.map
