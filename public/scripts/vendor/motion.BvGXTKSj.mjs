...
function fn(e, t, { delay: n = 0, transitionOverride: r, type: i } = {}) {
  ...
  for (let t in c) {
    ...
    r.start(au(t, r, i, h && su.has(t) ? { type: !1 } : s, e, m));
    let g = r.animation;
    g && f.push(g);
  }
  if (s) {
  ...
  let [r, i, a] = wn(e, n),
    s = (e) => {
      ...
      let a = t(r, e),
        ...
        l = (e) => {
          c(e, r === o || r === document || n.useGlobalTarget || Au(r, e.target));
        },
        u = (e) => {
          c(e, !1);
        };
  ...
  return (
    ...
    () => {
      (Hu.delete(e),
        !Hu.size &&
          typeof Uu == `function` &&
          (o.removeEventListener(`resize`, Uu), (Uu = void 0)));
    }
  );
}
function Bn(e, t) {
...
function Ji({ children: e, isPresent: t, anchorX: n, anchorY: r, root: i, pop: a }) {
  let o = g(),
    s = b(null),
    c = b({ width: 0, height: 0, top: 0, left: 0, right: 0, bottom: 0, direction: `ltr` }),
    { nonce: d } = u($),
...
function oa({ children: e, isValidProp: t, ...n }) {
  ...
  return _($.Provider, { value: i, children: e });
}
...
function ua(e) {
  let { initial: t, animate: n } = la(e, u(pf));
...
function xa(e, t, n, r, i, a) {
  ...
  let v = g.current,
    y = u(hf);
  v && !v.projection && i && (v.type === `html` || v.type === `svg`) && Sa(g.current, n, i, y);
  let x = b(!1);
  p(() => {
...
function wa(e, { forwardMotionProps: t = !1, type: n } = {}, r, i) {
  ...
  function c(n, c) {
    ...
    return x(pf.Provider, {
      value: p,
      children: [
        l && p.visualElement ? _(l, { visualElement: p.visualElement, ...d }) : null,
...
function Qa(e) {
  let [t, n] = Xi(),
    r = u(Ms);
  return _(zf, { ...e, layoutGroup: r, switchLayoutGroup: u(hf), isPresent: t, safeToRemove: n });
}
function $a(e, t, n) {
  let { props: r } = e;
...
function ko(e, t) {
  return o === void 0 ? !1 : e ? Ml() && !!bo(t) : jl();
}
...
function Cs({ children: e, as: t = `ul`, axis: n = `y`, onReorder: r, values: i, ...a }, o) {
  let c = M(() => Qf[t]),
    l = [],
    u = b(!1),
    d = b(null),
    f = {
      ...
      registerItem: (e, t) => {
        ...
        (r === -1 ? l.push({ value: e, layout: t[n] }) : (l[r].layout = t[n]), l.sort(ws));
      },
      updateOrder: (e, t, n) => {
        if (u.current) return;
        let a = Ss(l, e, t, n);
  ...
  return _(c, {
    ...
    ref: p,
    ignoreStrict: !0,
    children: _(kp.Provider, { value: f, children: e }),
  });
}
function ws(e, t) {
...
function ks(e, t, n, r) {
  ...
  let i = Ds(e, n);
  if (!i) return;
  let { amount: a, edge: s } = Os(t - (n === `x` ? o.scrollX : o.scrollY), i, n);
  if (s === null) {
...
function js(
  ...
  let l = M(() => Qf[r]),
    ...
    { axis: m, registerItem: h, updateOrder: g, groupRef: v } = d;
  return _(l, {
    drag: m,
    ...s,
    dragSnapToOrigin: !0,
    ...
    onDrag: (e, t) => {
      let { velocity: r, point: a } = t,
        o = f[m].get();
      (g(n, o, r[m]), ks(v.current, a[m], m, r[m]), i && i(e, t));
    },
    onDragEnd: (e, t) => {
      (Ts(), a && a(e, t));
    },
...
var Ms,
  ...
  Rp = t(() => {
    (n(),
      ...
      (kl = (e) => e.startsWith(`--`)),
      (Al = {}),
      (jl = Ft(() => o.ScrollTimeline !== void 0, `scrollTimeline`)),
      (Ml = Ft(() => o.ViewTimeline !== void 0, `viewTimeline`)),
      (Nl = Ft(() => {
        try {
      ...
      (qd = (e) => m !== void 0 && m.userAgent && m.userAgent.toLowerCase().includes(e)),
      ...
      (Qd = bi({
        ...
        defaultParent: () => {
          if (!Zd.current) {
            let e = new Yd({});
            (e.mount(o), e.setOptions({ layoutScroll: !0 }), (Zd.current = e));
          }
          return Zd.current;
        },
        resetTransform: (e, t) => {
      ...
      (ef = ({
        ...
        return (
          ...
          _(Fs.Provider, { value: y, children: e })
        );
      }),
      (tf = (e) => e.key || ``),
      (nf = ({
        ...
        if (h !== w) {
          ...
          for (let t = 0; t < T.length; t++) {
            let n = T[t],
              r = tf(n);
            g.includes(r) || (e.splice(t, 0, n), E.push(n));
          }
          return (a === `wait` && E.length && (e = E), te(Zi(e)), ee(h), null);
        }
        let { forceRender: ne } = u(Ms);
        return _(C, {
          children: T.map((e) => {
            let u = tf(e),
              d = o && !p ? !1 : h === T || g.includes(u);
            return _(
              ef,
              {
                isPresent: d,
                ...
                onExitComplete: d
                  ...
                  : () => {
                      ...
                      if (x.has(u)) (S.current.add(u), x.set(u, !0));
                      else return;
                      let e = !0;
                      (x.forEach((t) => {
                        t || (e = !1);
                      }),
                        e && (ne?.(), te(y.current), o && m?.(), r && r()));
                    },
                anchorX: s,
                anchorY: c,
                children: e,
      ...
      (af = (e) => e === !0),
      (of = (e) => af(e === !0) || e === `id`),
      (sf = ({ children: e, id: t, inherit: n = !0 }) => {
        let r = u(Ms),
          i = u(rf),
          [a, o] = $i(),
          s = b(null),
        ...
        s.current === null &&
          (of(n) && c && (t = t ? c + `-` + t : c),
          (s.current = { id: t, group: (af(n) && r.group) || Wi() }));
        let l = d(() => ({ ...s.current, forceRender: a }), [o]);
        return _(Ms.Provider, { value: l, children: e });
      }),
      (cf = T({ strict: !1 })),
      (lf = {
        animation: [
    ...
    ((pf = T({})),
      ...
      (Df = (e, t) => Math.abs(e - t)),
      (Of = (e, t) => ((t.isSVG ?? _a(e)) ? new xd(t) : new md(t, { allowProjection: e !== c }))),
      ...
      (dp = new WeakMap()),
      (fp = new WeakMap()),
      (pp = (e) => (e === document.scrollingElement ? o : e)),
      (mp = [
        [op.Enter, `entry`],
        [op.Exit, `exit`],
        [op.Any, `cover`],
...
//# sourceMappingURL=motion.BvGXTKSj.mjs.map
