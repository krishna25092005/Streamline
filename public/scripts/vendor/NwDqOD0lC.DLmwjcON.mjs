...
var r,
  ...
  o = e(() => {
    (t(),
      n.loadFonts([`FR;InterDisplay-Medium`, `Inter-Bold`, `Inter-BoldItalic`, `Inter-Italic`]),
      (r = [
        {
          explicitInter: !0,
          fonts: [
