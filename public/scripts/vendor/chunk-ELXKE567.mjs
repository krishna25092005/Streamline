import { a as Ct, d as Ot, e as Dt } from "chunk-D37MXY4U.mjs";
import { a as At } from "chunk-4UJWGAST.mjs";
import { E as vt, F as Rt, L as Hn, W as $n, X as Nt, Y as Gn, ia as jn } from "chunk-XRJTL357.mjs";
...
var xo = "Sentry Logger ",
  Ie = ["debug", "info", "warn", "error", "log", "assert", "trace"],
  fe = {};
function w(e) {
...
var f = te("logger", bo);
var Wn = /\(error: (.*)\)/,
  Yn = /captureMessage|captureException/;
function Ue(...e) {
...
`);
    for (let a = r; a < s.length; a++) {
      ...
      let u = Wn.test(c) ? c.replace(Wn, "$1") : c;
      if (!u.match(/\S*Error: /)) {
        for (let p of t) {
          let l = p(u);
          if (l) {
...
function kt(e) {
  return Array.isArray(e) ? Ue(...e) : e;
}
function zn(e) {
  if (!e.length) return [];
  let t = Array.from(e);
  return (
    /sentryWrapped/.test(Fe(t).function || "") && t.pop(),
    t.reverse(),
    Yn.test(Fe(t).function || "") && (t.pop(), Yn.test(Fe(t).function || "") && t.pop()),
    t
      .slice(0, 50)
      .map((n) => ({ ...n, filename: n.filename || Fe(t).filename, function: n.function || "?" }))
  );
}
function Fe(e) {
  return e[e.length - 1] || {};
...
function F(e) {
  try {
    return !e || typeof e != "function" ? wt : e.name || wt;
  } catch {
    return wt;
  }
}
  ...
  (($e = d.onerror),
    (d.onerror = function (e, t, n, r, o) {
      return (
        ...
        $e && !$e.__SENTRY_LOADER__ ? $e.apply(this, arguments) : !1
      );
    }),
...
function ve(e, t = {}) {
  ...
  try {
    let n = e,
      ...
      l = (!Array.isArray(t) && t.maxStringLength) || No;
    for (
      ;
      n &&
      i++ < r &&
      ((u = Ao(n, p)), !(u === "html" || (i > 1 && s + o.length * c + u.length >= l)));
    )
...
function Ye(e, t) {
  ...
  for (let r = 0; r < e.length; r++) {
    let o = e[r];
    try {
      be(o) ? n.push("[VueViewModel]") : n.push(String(o));
    } catch {
...
function Jn(e, t, n = !1) {
  return A(e) ? (Ut(t) ? t.test(e) : A(t) ? (n ? e === t : e.includes(t)) : !1) : !1;
}
function me(e, t = [], n = !1) {
  return t.some((r) => Jn(e, r, n));
}
function x(e, t, n) {
  if (!(t in e)) return;
  let r = e[t],
    o = n(r);
  typeof o == "function" && ze(o, r);
  try {
    e[t] = o;
  } catch {
...
function qe(e) {
  if (ie(e)) return { message: e.message, name: e.name, stack: e.stack, ...Xn(e) };
  if (ae(e)) {
    let t = { type: e.type, target: Vn(e.target), currentTarget: Vn(e.currentTarget), ...Xn(e) };
    return (typeof CustomEvent < "u" && W(e, CustomEvent) && (t.detail = e.detail), t);
  } else return e;
}
function Vn(e) {
  try {
    return Ft(e) ? ve(e) : Object.prototype.toString.call(e);
  } catch {
    return "<unknown>";
  }
}
...
function jt(e, t) {
  if (Co(e)) {
    ...
    let r = {};
    t.set(e, r);
    for (let o of Object.getOwnPropertyNames(e)) typeof e[o] < "u" && (r[o] = jt(e[o], t));
    return r;
  }
  if (Array.isArray(e)) {
    let n = t.get(e);
...
var k = Oo(),
  ...
  Do = (() => {
    ...
    return i || u
      ? o <= c
        ? ((Re = "timeOrigin"), e.timeOrigin)
        : ((Re = "navigationStart"), s)
      : ((Re = "dateNow"), r);
  })();
function b() {
  let e = d,
...
function he(e, t, n = 2) {
  ...
  let r = { ...e };
  for (let o in t) Object.prototype.hasOwnProperty.call(t, o) && (r[o] = he(r[o], t[o], n - 1));
  return r;
}
var zt = "_sentrySpan";
function qt(e, t) {
  t ? C(e, zt, t) : delete e[zt];
}
function Kt(e) {
  return e[zt];
}
var ko = 100,
  Jt = class e {
    ...
    setSDKProcessingMetadata(t) {
      return ((this._sdkProcessingMetadata = he(this._sdkProcessingMetadata, t, 2)), this);
    }
  ...
  M = Jt;
function nr() {
  return te("defaultCurrentScope", () => new M());
}
function rr() {
  return te("defaultIsolationScope", () => new M());
}
var Vt = class {
  constructor(t, n) {
    let r;
...
function _e() {
  let e = oe(),
    t = xe(e);
  return (t.stack = t.stack || new Vt(nr(), rr()));
}
function Po(e) {
  return _e().withScope(e);
}
function Mo(e, t) {
  let n = _e();
...
function or(e) {
  return _e().withScope(() => e(_e().getIsolationScope()));
}
function ir() {
  return {
    ...
    withScope: Po,
    withSetScope: Mo,
    withSetIsolationScope: (e, t) => or(t),
    getCurrentScope: () => _e().getScope(),
    getIsolationScope: () => _e().getIsolationScope(),
  };
}
function Je(e) {
  let t = xe(e);
  return t.acs ? t.acs : ir();
}
function O() {
  let e = oe();
  return Je(e).getCurrentScope();
}
function P() {
  let e = oe();
  return Je(e).getIsolationScope();
}
function Ve() {
  return te("globalScope", () => new M());
}
function Ee(...e) {
  let t = oe(),
    n = Je(t);
...
function hr(e, t) {
  let n = t.getOptions(),
    ...
    o = y({ environment: n.environment || ye, release: n.release, public_key: r, trace_id: e });
...
function Er(e) {
  ...
  let o = n.spanContext().traceState,
    ...
    s = i && cr(i);
  if (s) return s;
  let a = hr(e.spanContext().traceId, t),
    c = Se(n),
    u = c.data || {},
    p = u[Qt];
...
function yr(e) {
  ...
  return Tr({ host: i, pass: o, path: c, projectId: u, port: s, protocol: n, publicKey: r });
}
function Tr(e) {
  return {
    protocol: e.protocol,
...
function nn(e) {
  let t = typeof e == "string" ? yr(e) : Tr(e);
  if (!(!t || !Ko(t))) return t;
}
function Ir() {
...
function Xe(e, t = 3, n = 100 * 1024) {
  let r = j(e, t);
  return Zo(r) > n ? Xe(e, t - 1, n) : r;
}
function rn(e, t, n = 1 / 0, r = 1 / 0, o = Ir()) {
  let [i, s] = o;
  if (
    t == null ||
...
function Jo(e, t) {
  try {
    ...
    if (be(t)) return "[VueViewModel]";
    if (Bt(t)) return "[SyntheticEvent]";
    if (typeof t == "number" && !Number.isFinite(t)) return `[${t}]`;
    if (typeof t == "function") return `[Function: ${F(t)}]`;
...
function an(e) {
  ...
  function o(i) {
    typeof r == "string"
      ? (r = typeof i == "string" ? r + i : [on(r), i])
      : r.push(typeof i == "string" ? on(i) : i);
  }
  for (let i of n) {
    let [s, a] = i;
    if (
...
function cn(e) {
  let t = typeof e.data == "string" ? on(e.data) : e.data;
  return [
    y({
      type: "attachment",
      length: t.length,
  ...
  return new G((o, i) => {
    ...
    if (t === null || typeof s != "function") o(t);
      ...
      (m && s.id && a === null && f.log(`Event processor "${s.id}" dropped event`),
        J(a)
          ? a.then((c) => tt(e, c, n, r + 1).then(o)).then(null, i)
          : tt(e, a, n, r + 1)
              .then(o)
              .then(null, i));
    }
...
function Nr(e, t) {
  ...
  (ri(e, t), r && si(e, r), ai(e, n), oi(e, o), ii(e, i));
}
function pn(e, t) {
  let {
    extra: n,
  ...
  (ot(e, "extra", n),
    ...
    ot(e, "user", o),
    ot(e, "contexts", i),
    (e.sdkProcessingMetadata = he(e.sdkProcessingMetadata, a, 2)),
    s && (e.level = s),
...
function si(e, t) {
  ((e.contexts = { trace: lr(t), ...e.contexts }),
    (e.sdkProcessingMetadata = { dynamicSamplingContext: Er(t), ...e.sdkProcessingMetadata }));
  let n = Ne(t),
    r = Se(n).description;
...
function Ar(e, t, n, r, o, i) {
  ...
  (E.length && (n.attachments = E), Nr(c, g));
  let h = [...l, ...g.eventProcessors];
  return tt(h, c, n).then((v) => (v && pi(v), typeof s == "number" && s > 0 ? li(v, s, a) : v));
}
function ci(e, t) {
  let { environment: n, release: r, dist: o, maxValueLength: i = 250 } = t;
  ((e.environment = e.environment || n || ye),
...
function Cr(e) {
  if (e) return mi(e) ? { captureContext: e } : hi(e) ? { captureContext: e } : e;
}
function mi(e) {
...
function hi(e) {
  return Object.keys(e).some((t) => gi.includes(t));
}
function Te(e, t) {
  return O().captureException(e, Cr(t));
}
function Ae(e, t) {
...
function Ce(e) {
  let t = S(),
    n = P(),
    r = O(),
    { release: o, environment: i = ye } = (t && t.getOptions()) || {},
...
function st() {
  ...
  (n && tr(n), Pr(), e.setSession(), t.setSession());
}
function Pr() {
  let e = P(),
    t = O(),
...
var Br = "Not capturing exception because it's already been captured.",
  De = class {
    constructor(t) {
      if (
        ((this._options = t),
        ...
        let o = Mr(this._dsn, t.tunnel, t._metadata ? t._metadata.sdk : void 0);
    ...
    captureMessage(t, n, r, o) {
      let i = { event_id: b(), ...r },
        s = de(t) ? t : String(t),
        a = se(t) ? this.eventFromMessage(s, n, i) : this.eventFromException(t, i);
      return (this._process(a.then((c) => this._captureEvent(c, i, o))), i.event_id);
    }
    captureEvent(t, n, r) {
      let o = b();
      if (n && n.originalException && Ke(n.originalException)) return (m && f.log(Br), o);
      let i = { event_id: o, ...n },
    ...
    addIntegration(t) {
      ...
      (mn(this, t, this._integrations), n || dn(this, [t]));
    }
    sendEvent(t, n = {}) {
      this.emit("beforeSendEvent", t, n);
      let r = br(t, this._dsn, this._options._metadata, this._options.tunnel);
      for (let i of n.attachments || []) r = sn(r, cn(i));
      let o = this.sendEnvelope(r);
      o && o.then((i) => this.emit("afterSendEvent", t, i), null);
    }
    sendSession(t) {
      let n = xr(t, this._dsn, this._options._metadata, this._options.tunnel);
      this.sendEnvelope(n);
    }
    ...
    sendEnvelope(t) {
      return (
        ...
        this._isEnabled() && this._transport
          ...
          : (m && f.error("Transport disabled"), U({}))
      );
    }
    _setupIntegrations() {
      let { integrations: t } = this._options;
      ((this._integrations = Fr(this, t)), dn(this, t));
    }
    ...
    _prepareEvent(t, n, r = O(), o = P()) {
      ...
      return (
        ...
        Ar(i, t, n, r, this, o).then((a) => {
          if (a === null) return a;
          a.contexts = { trace: Xt(r), ...a.contexts };
          let c = _r(this, r);
          return (
        ...
        .then((h) => {
          if (h === null)
            throw (
              ...
              new D("An event processor returned `null`, will not send event.", "log")
            );
        ...
        .then((h) => {
          if (h === null) {
            if ((this.recordDroppedEvent("before_send", l, t), s)) {
              let bt = 1 + (t.spans || []).length;
              this.recordDroppedEvent("before_send", "span", bt);
            }
            throw new D(`${u} returned \`null\`, will not send event.`, "log");
          }
          let Me = r && r.getSession();
          if ((!s && Me && this._updateSessionFromEvent(Me, h), s)) {
            let Le =
                (h.sdkProcessingMetadata && h.sdkProcessingMetadata.spanCountBeforeProcessing) || 0,
              bt = h.spans ? h.spans.length : 0,
              Bn = Le - bt;
            Bn > 0 && this.recordDroppedEvent("before_send", "span", Bn);
          }
          let v = h.transaction_info;
          if (s && v && h.transaction !== t.transaction) {
            let Le = "custom";
            h.transaction_info = { ...v, source: Le };
          }
          return (this.sendEvent(h, n), h);
        })
        .then(null, (h) => {
          throw h instanceof D
            ? h
...
Reason: ${h}`));
    ...
    _flushOutcomes() {
      ...
      let n = Ur(t, this._options.tunnel && Q(this._dsn));
      this.sendEnvelope(n);
    }
  };
function Ii(e, t) {
  ...
  if (J(e))
    return e.then(
      (r) => {
        if (!H(r) && r !== null) throw new D(n);
        return r;
      },
      (r) => {
        throw new D(`${t} rejected with ${r}`);
      }
    );
  if (!H(e) && e !== null) throw new D(n);
  return e;
}
function xi(e, t, n, r) {
  let { beforeSend: o, beforeSendTransaction: i, beforeSendSpan: s } = t;
  if (Hr(n) && o) return o(n, r);
  if ($r(n)) {
    if (n.spans && s) {
      let a = [];
      for (let c of n.spans) {
        let u = s(c);
        u ? a.push(u) : (mr(), e.recordDroppedEvent("before_send", "span"));
      }
      n.spans = a;
    }
    if (i) {
...
function Gr(e) {
  ...
  function o(s) {
    if (!n()) return ne(new D("Not adding Promise because buffer limit was reached."));
    let a = s();
    return (
...
function Wr(e, { statusCode: t, headers: n }, r = Date.now()) {
  let o = { ...e },
  ...
  else s ? (o.all = r + bi(s, r)) : t === 429 && (o.all = r + 60 * 1e3);
  return o;
}
var Ri = 64;
function at(e, t, n = Gr(e.bufferSize || Ri)) {
  let r = {},
    o = (s) => n.drain(s);
  function i(s) {
    let a = [];
...
function K(e, t) {
  let n = S(),
    r = P();
  if (!n) return;
  let { beforeBreadcrumb: o = null, maxBreadcrumbs: i = Ni } = n.getOptions();
  if (i <= 0) return;
  let a = { timestamp: z(), ...e },
    c = o ? w(() => o(a, t)) : a;
...
function Mi(e, t) {
  return e.type || !t || !t.length ? !1 : Bi(e).some((n) => me(n, t));
}
function Li(e, t) {
...
function Sn(e, t, n = 250, r, o, i, s) {
  ...
  a && (i.exception.values = ji(En(e, t, o, s.originalException, r, i.exception.values, a, 0), n));
}
function En(e, t, n, r, o, i, s, a) {
  ...
  if (W(r[o], Error)) {
    ...
    let u = e(t, r[o]),
      p = c.length;
    (Jr(u, o, p, a), (c = En(e, t, n, r[o], o, [u, ...c], u, p)));
  }
  return (
    Array.isArray(r.errors) &&
      r.errors.forEach((u, p) => {
        if (W(u, Error)) {
          ...
          let l = e(t, u),
            g = c.length;
          (Jr(l, `errors[${p}]`, g, a), (c = En(e, t, n, u, o, [l, ...c], l, g)));
        }
      }),
    c
  );
...
var Yi = "Dedupe",
  ...
  ft = zi;
function qi(e, t) {
  return t ? !!(Ki(e, t) || Ji(e, t)) : !1;
}
function Ki(e, t) {
  let n = e.message,
    r = t.message;
  return !((!n && !r) || (n && !r) || (!n && r) || n !== r || !Zr(e, t) || !Xr(e, t));
}
function Ji(e, t) {
  let n = Vr(t),
    r = Vr(e);
  return !(!n || !r || n.type !== r.type || n.value !== r.value || !Zr(e, t) || !Xr(e, t));
}
function Xr(e, t) {
  let n = Be(e),
    r = Be(t);
...
function vn(e, t) {
  let n = "fetch";
  (R(n, e), N(n, () => Vi(void 0, t)));
}
function Vi(e, t = !1) {
  (t && !xn()) ||
    x(d, "fetch", function (n) {
      return function (...r) {
        let { method: o, url: i } = Xi(r),
        ...
        return n.apply(d, r).then(
          ...
          (c) => {
            throw (
              ...
              ie(c) && c.stack === void 0 && ((c.stack = a), C(c, "framesToPop", 1)),
              c
            );
          }
        );
...
function Xi(e) {
  ...
  if (e.length === 2) {
    let [n, r] = e;
    return { url: Qr(n), method: bn(r, "method") ? String(r.method).toUpperCase() : "GET" };
  }
  let t = e[0];
  return { url: Qr(t), method: bn(t, "method") ? String(t.method).toUpperCase() : "GET" };
}
function Rn() {
  return "npm";
}
...
function ue(e, t = {}, n) {
    ...
    try {
      ...
      throw (
        ...
        Ee((s) => {
          (s.addEventProcessor(
            (a) => (
              t.mechanism && (ge(a, void 0, void 0), V(a, t.mechanism)),
  ...
  (ze(r, e), C(e, "__sentry_wrapped__", r));
  try {
...
function as(e, t, n, r) {
  let o = S(),
    ...
    s = gs(t),
    a = { __serialized__: Xe(t, i) };
  if (s) return { exception: { values: [ht(e, s)] }, extra: a };
  let c = {
    exception: {
      values: [
        {
          type: ae(t) ? t.constructor.name : r ? "UnhandledRejection" : "Error",
          value: ds(t, { isUnhandledRejection: r }),
        },
      ],
    },
    extra: a,
...
function On(e, t) {
  return { exception: { values: [ht(e, t)] } };
}
function wn(e, t) {
...
var cs = /Minified React error #\d+;/i;
function us(e) {
  return e && cs.test(e.message) ? 1 : 0;
}
function ps(e) {
...
function ls(e) {
  ...
  return t
    ? t.error && typeof t.error.message == "string"
      ? t.error.message
      : eo(e) && Array.isArray(e.message) && e.message.length == 2
        ? e.message[1]
        : t
    : "No error message";
}
function to(e, t, n, r) {
  let o = (n && n.syntheticException) || void 0,
    i = _t(e, t, o, r);
  return (V(i), (i.level = "error"), n && n.event_id && (i.event_id = n.event_id), U(i));
}
function no(e, t, n = "info", r, o) {
...
function _t(e, t, n, r, o) {
  let i;
  if (je(t) && t.error) return On(e, t.error);
  if (We(t) || Lt(t)) {
    let s = t;
    if ("stack" in t) i = On(e, t);
    else {
      let a = s.name || (We(s) ? "DOMError" : "DOMException"),
  ...
  return ie(t)
    ? On(e, t)
    : H(t) || ae(t)
      ? ((i = as(e, t, n, o)), V(i, { synthetic: !0 }), i)
      : ((i = Dn(e, t, n, r)), ge(i, `${t}`, void 0), V(i, { synthetic: !0 }), i);
}
function Dn(e, t, n, r) {
  let o = {};
  if (r && n) {
...
function ds(e, { isUnhandledRejection: t }) {
  ...
  return je(e)
    ...
    : ae(e)
      ? `Event \`${ms(e)}\` (type=${e.type}) captured as ${r}`
...
function ro(e, { metadata: t, tunnel: n, dsn: r }) {
  let o = {
      event_id: e.event_id,
      sent_at: new Date().toISOString(),
...
var Et = class extends De {
  constructor(t) {
    let n = { parentSpanIsAlwaysRootSpan: !0, ...t },
      r = _.SENTRY_SDK_SOURCE || Rn();
    (_n(n, "browser", ["browser"], r),
      super(n),
      n.sendClientReports &&
        _.document &&
  ...
  eventFromMessage(t, n = "info", r) {
    return no(this._options.stackParser, t, n, r, this._options.attachStacktrace);
  }
...
function so(e, t = !1) {
  return (n) => {
    ...
    let r = Ts(n);
    if (ys(n.type, r)) return;
    (C(n, "_sentryCaptured", !0), r && !r._sentryId && C(r, "_sentryId", b()));
    let o = n.type === "keypress" ? "input" : n.type;
    (Ss(n) || (e({ event: n, name: o, global: t }), (kn = n.type), (Pn = r ? r._sentryId : void 0)),
      clearTimeout(io),
      (io = T.setTimeout(() => {
        ((Pn = void 0), (kn = void 0));
      }, _s)));
...
function Is() {
  ...
  T.onpopstate = function (...n) {
    let r = T.location.href,
      o = St;
    if (((St = r), I("history", { from: o, to: r }), e))
      try {
...
function Ln(e) {
  ...
  if (r && typeof r.createElement == "function")
    try {
      ...
      oo && f.warn(`Could not create sandbox iframe for ${e} check, bailing to window.${e}: `, o);
    }
  return n && (yt[e] = n.bind(T));
}
function Tt(e) {
  yt[e] = void 0;
}
var pe = "__sentry_xhr_v3__";
function Fn(e) {
  (R("xhr", e), N("xhr", xs));
}
function xs() {
  ...
  ((e.open = new Proxy(e.open, {
    apply(t, n, r) {
      ...
      ((n[pe] = { method: i, url: s, request_headers: {} }),
...
function ao(e, t = Ln("fetch")) {
  ...
  function o(i) {
    ...
    if (!t) return (Tt("fetch"), ne("No fetch implementation available"));
    try {
...
var Ns = /^\s*at (\S+?)(?::(\d+))(?::(\d+))\s*$/i,
  ...
  ks = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i,
  Ps = (e) => {
    let t = ws.exec(e);
    if (t) {
      ...
      let r = t[3],
        o = t[1] || "?";
      return (([o, r] = uo(o, r)), Un(r, o, t[4] ? +t[4] : void 0, t[5] ? +t[5] : void 0));
    }
  },
  Ms = [Rs, Ps];
var Ls = [Ds, Ms],
    ...
    return {
      ...
      setup(n) {
        (t.console && yn($s(n)),
          ...
          t.fetch && vn(js(n)),
          t.history && Pe(Ws(n)),
          t.sentry && n.on("beforeSendEvent", Bs(n)));
      },
    };
  },
  po = Us;
...
function Hs(e, t) {
  return function (r) {
    ...
    (a &&
      ...
      (ee &&
        f.warn(
          `\`dom.maxStringLength\` cannot exceed ${It}, but a value of ${a} was configured. Sentry will use ${It} instead.`
        ),
      (a = It)),
      typeof s == "string" && (s = [s]));
    try {
      let u = r.event,
        p = Ys(u) ? u.target : u;
      ((o = ve(p, { keyAttrs: s, maxStringLength: a })), (i = Gt(p)));
    } catch {
      o = "<unknown>";
    }
...
function $s(e) {
  return function (n) {
    ...
    if (n.level === "assert")
      if (n.args[0] === !1)
        ((r.message = `Assertion failed: ${Ye(n.args.slice(1), " ") || "console.assert"}`),
...
var zs = [
  ...
  Ks = (e = {}) => {
    ...
    return {
      name: qs,
      setupOnce() {
        (t.setTimeout && x(_, "setTimeout", fo),
          t.setInterval && x(_, "setInterval", fo),
          t.requestAnimationFrame && x(_, "requestAnimationFrame", Js),
          t.XMLHttpRequest && "XMLHttpRequest" in _ && x(XMLHttpRequest.prototype, "send", Vs));
        let n = t.eventTarget;
        n && (Array.isArray(n) ? n : zs).forEach(Xs);
      },
    };
  },
  lo = Ks;
function fo(e) {
  return function (...t) {
    let n = t[0];
    return (
      (t[0] = ue(n, { mechanism: { data: { function: F(e) }, handled: !1, type: "instrument" } })),
      e.apply(this, t)
    );
  };
}
function Js(e) {
  return function (t) {
    return e.apply(this, [
      ue(t, {
        mechanism: {
          data: { function: "requestAnimationFrame", handler: F(e) },
          handled: !1,
          type: "instrument",
        },
      }),
      ...
      ["onload", "onerror", "onprogress", "onreadystatechange"].forEach((o) => {
        o in n &&
          ...
          x(n, o, function (i) {
            let s = {
                mechanism: {
                  data: { function: o, handler: F(i) },
                  handled: !1,
                  type: "instrument",
                },
              },
              a = ce(i);
            return (a && (s.mechanism.data.handler = F(a)), ue(i, s));
          });
      }),
      e.apply(this, t)
    );
      ...
      return function (o, i, s) {
        try {
          typeof i.handleEvent == "function" &&
            (i.handleEvent = ue(i.handleEvent, {
              mechanism: {
                data: { function: "handleEvent", handler: F(i), target: e },
                handled: !1,
                type: "instrument",
              },
            }));
        ...
        return r.apply(this, [
          ...
          ue(i, {
            mechanism: {
              data: { function: "addEventListener", handler: F(i), target: e },
              handled: !1,
              type: "instrument",
            },
          }),
...
var Zs = "GlobalHandlers",
  Qs = (e = {}) => {
    ...
    return {
      ...
      setup(n) {
        (t.onerror && (ea(n), mo("onerror")),
          t.onunhandledrejection && (ta(n), mo("onunhandledrejection")));
      },
    };
  },
  go = Qs;
function ea(e) {
  Pt((t) => {
    let { stackParser: n, attachStacktrace: r } = ho();
    if (S() !== e || Cn()) return;
    let { msg: o, url: i, line: s, column: a, error: c } = t,
      u = oa(_t(n, c || o, void 0, r, !1), i, s, a);
    ((u.level = "error"),
      Ae(u, { originalException: c, mechanism: { handled: !1, type: "onerror" } }));
  });
}
function ta(e) {
  Mt((t) => {
    ...
    if (S() !== e || Cn()) return;
    let o = na(t),
      i = se(o) ? ra(o) : _t(n, o, void 0, r, !0);
    ((i.level = "error"),
      Ae(i, { originalException: o, mechanism: { handled: !1, type: "onunhandledrejection" } }));
  });
}
function na(e) {
  if (se(e)) return e;
  ...
  ca = (e = {}) => {
    ...
    return {
      ...
      preprocessEvent(r, o, i) {
        let s = i.getOptions();
        Sn(ht, s.stackParser, s.maxValueLength, n, t, r, o);
      },
    };
  },
  Eo = ca;
function So(e) {
  return [pt(), ct(), lo(), po(), go(), Eo(), ft(), _o()];
}
function ua(e = {}) {
  let t = {
    defaultIntegrations: So(),
    release:
...
function fa(e = {}) {
  let t = ua(e);
  if (!t.skipBrowserExtensionCheck && pa()) {
    w(() => {
      console.error(
  ...
  let n = {
      ...t,
      stackParser: kt(t.stackParser || co),
      integrations: ln(t),
      transport: t.transport || ao,
    },
    r = gn(Et, n);
  return (t.autoSessionTracking && la(), r);
}
function la() {
  ...
  (Ce({ ignoreDuration: !0 }),
    Oe(),
    Pe(({ from: e, to: t }) => {
      e !== void 0 && e !== t && (Ce({ ignoreDuration: !0 }), Oe());
    }));
}
var ga = "__debugPerformance",
  ha = typeof window < "u" ? window.location : void 0,
  yo = new URLSearchParams(ha?.search).has(ga),
  To = !1,
  _a = typeof window < "u" ? window.navigator : void 0,
  Ea = _a?.userAgent || "",
  xt = window;
function Sa() {
  if (xt.__isApiPlugin === !0) return !0;
  try {
...
var ig = {
    isDebugBuild: !Rt() && !vt(),
    isNotProductionBuild: !Rt(),
    isTest: vt(),
    isAutomation: xt.__isAutomationEditorSession === !0,
    isE2E: xt.__isE2E === !0,
    isIntegrationTest: xt.__isIntegrationTest === !0,
    isApiPlugin: Sa(),
    isBrowserAgentEvalsBuild: !1,
    userAgent: Ea,
    isPhone: Hn(),
    benchmarkSkipRendering: !1,
    benchmarkSkipTreeVerify: yo,
    debugPerformance: yo,
  },
  Io;
ya(() => {});
...
function ag({ name: e, security: t }) {
  To ||
    ((To = !0),
    $n(({ error: n, tags: r, extras: o, critical: i }) => {
      Ee((s) => {
        (s.setTags(r), o && s.setExtras(o), i && s.setLevel("fatal"), Te(n));
      });
    }),
    (At.log = jn(e).extend("services")),
    ...
    t.allowChannelToOpenerWithOrigin &&
      Dt.initializeTrustedOrigin(t.allowChannelToOpenerWithOrigin),
    window.addEventListener("pagehide", () => {
      (it(),
        At.log.debug("Unregistering services to parent/opener frame when unloading"),
        Ct.shared().unregister(Ot).catch(Nt),
        Ct.shared().unregister(Dt).catch(Nt));
    }));
}
export {
  Ee as a,
...
//# sourceMappingURL=chunk-ELXKE567.mjs.map
