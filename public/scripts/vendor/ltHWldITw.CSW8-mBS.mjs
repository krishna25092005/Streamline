...
import { C as l } from "./motion.BvGXTKSj.mjs";
import { D as u, G as d, b as ee, m as te, o as f, r as ne, t as re } from "./framer.CF3iZfO7.mjs";
function ie(e) {
...
function Le(e, t) {
  let n = e.value,
    r = t.value;
  if ((g(n) && g(r)) || (h(n) && h(r))) return n < r ? -1 : +(n > r);
  throw Error(`Invalid rich text pointer`);
}
function Re(e) {
...
async function We(e) {
  let t = Math.floor(z * (Math.random() + 1) * 2 ** (e - 1));
  await new Promise((e) => {
    setTimeout(e, t);
  });
}
      ...
      (qe = (e, t, n, r) => {
        if ((t && typeof t == `object`) || typeof t == `function`)
          for (let i of w(t))
            E.call(e, i) ||
              i === n ||
              S(e, i, { get: () => t[i], enumerable: !(r = C(t, i)) || r.enumerable });
        return e;
      }),
      (k = (e, t, n) => (
        (n = e == null ? {} : x(T(e))),
        qe(!t && e && e.__esModule ? n : S(n, `default`, { value: e, enumerable: !0 }), e)
      )),
      (A = (e, t, n) => D(e, typeof t == `symbol` ? t : t + ``, n)),
      (j = k(
        O({
...
` +
      ...
      (N = class {
        ...
        constructor(e) {
          ((this.bytes = e),
            A(this, `offset`, 0),
            A(this, `view`),
            A(this, `decoder`, new TextDecoder()),
            (this.view = ie(this.bytes)));
        }
      }),
      ...
      (L = class e {
        static fromString(t) {
          ...
          return (
            p(g(n), `Invalid chunkId`),
            p(g(r), `Invalid offset`),
            p(g(i), `Invalid length`),
            new e(n, r, i)
          );
        }
        toString() {
      ...
      ((e) => {
        ((e.read = function (e) {
          ...
          (e.compare = function (e, t, n) {
            ...
            switch (e.type) {
              case f.Array:
                return (p(t.type === f.Array), se(e, t, n));
              case f.Boolean:
                return (p(t.type === f.Boolean), ue(e, t));
              case f.Color:
                return (p(t.type === f.Color), pe(e, t));
              case f.Date:
                return (p(t.type === f.Date), ge(e, t));
              case f.Enum:
                return (p(t.type === f.Enum), ye(e, t));
              case f.File:
                return (p(t.type === f.File), Se(e, t));
              case f.Link:
                return (p(t.type === f.Link), Te(e, t));
              case f.Number:
                return (p(t.type === f.Number), Oe(e, t));
              case f.Object:
                return (p(t.type === f.Object), je(e, t, n));
              case f.ResponsiveImage:
                return (p(t.type === f.ResponsiveImage), Pe(e, t));
              case f.RichText:
                return (p(t.type === f.RichText), Le(e, t));
              case f.VectorSetItem:
                return (p(t.type === f.VectorSetItem), Ue(e, t));
              case f.String:
                return (p(t.type === f.String), Be(e, t, n));
              default:
                m(e);
            }
          }));
      ...
      (R = 3),
      (z = 250),
      (B = [408, 429, 500, 502, 503, 504]),
      (V = async (e, t) => {
        let n = 0;
        for (;;) {
          try {
            let r = await fetch(e, t);
            if (!B.includes(r.status) || ++n > R) return r;
          } catch (e) {
        ...
        write(e, t) {
          ...
          for (; i < a; i++) {
            ...
            if ((p(e, `Missing chunk`), !(n > e.end))) {
              if (n > e.start) {
                let r = n - e.start;
                ((t = y(e.data.subarray(0, r), t)), (n = e.start));
              }
              break;
            }
          }
                ...
                async (e) => {
                  ...
                  return (await Ge(this.url, t)).map((t, n) => {
                    let r = new N(t),
                      i = U.read(r),
                      a = e[n];
                    return (p(a, `Missing pointer`), { pointer: a, data: i.getData() });
                  });
                },
                { maxBatchSize: 250 }
              )
      ...
      (G = class {
        ...
        constructor(e) {
          ((this.options = e),
            ...
            A(this, `schema`),
            A(this, `indexes`),
            A(this, `resolveRichText`),
            A(this, `resolveVectorSetItem`),
            A(this, `chunks`),
            (this.chunks = this.options.chunks.map((e, t) => new W(t, e))),
...
function K(e) {
  return typeof e == `object` && !!e && !o(e) && J in e;
}
function Ye(e, ...t) {
  if (!e) throw Error(`Assertion Error` + (t.length > 0 ? `: ` + t.join(` `) : ``));
}
  ...
  return (n) => {
    ...
    let o = (function t(n) {
      switch (n[0]) {
        case 1: {
          let [, ...e] = n;
          return c(i, void 0, ...e.map(t));
        }
        case 2: {
          let [, e, ...r] = n;
          return c(te, e, ...r.map(t));
        }
        case 3: {
          let [, r, i, o, s] = n;
          for (let e of o) {
          ...
          for (let t of s) {
            ...
            let r = e[n];
            r && (K(r) && r.preload(), (i[t] = r));
          }
          let c = e[r];
          return (
            Ye(c, `Module not found`),
            K(c) && c.preload(),
            a(ne, {
              componentIdentifier: r,
              children: (e) => a(re, { component: c, props: { ...e, ...i } }),
            })
          );
        }
        case 4: {
  ...
  rt = e(() => {
    (d(),
      ...
      (Qe = {
        ...
        IoPXgFY0R: { isNullable: !0, type: f.String },
        nextItemId: { isNullable: !0, type: f.String },
        Nk41kXah5: { isNullable: !0, type: f.RichText },
        previousItemId: { isNullable: !0, type: f.String },
        UBXOjVnXB: { isNullable: !0, type: f.String },
        updatedAt: { isNullable: !0, type: f.Date },
        YnkrwhRtP: { isNullable: !0, type: f.Date },
      }),
      ($e = []),
      (et = (e) => {
        let t = $e[e];
      ...
      (Q = {
        collectionByLocaleId: {
          default: new G({
            chunks: [
              new URL(
                `./ltHWldITw-chunk-default-0.framercms`,
                `https://framerusercontent.com/modules/zlg41dCfOihsaqrspA4G/7YurYHNP7NFnq68RscH8/ltHWldITw.js`
              ).href.replace(`/modules/`, `/cms/`),
            ],
            id: `7db2070b-9d02-4fa1-b105-177f75628f21default`,
            indexes: [],
            resolveRichText: X,
        ...
        id: `7db2070b-9d02-4fa1-b105-177f75628f21`,
      }),
      u(Q, {
        IoPXgFY0R: { defaultValue: ``, title: `Title`, type: f.String },
        UBXOjVnXB: { preventLocalization: !1, title: `Slug`, type: f.String },
        YnkrwhRtP: { title: `Updated Date`, type: f.Date },
        Nk41kXah5: { defaultValue: ``, title: `Content`, type: f.RichText },
        createdAt: { title: `Created`, type: f.Date },
        updatedAt: { title: `Updated`, type: f.Date },
        previousItemId: {
          dataIdentifier: `local-module:collection/ltHWldITw:default`,
          title: `Previous`,
          ...
          let [n] = await Z.query(
            {
              ...
              select: [{ name: `UBXOjVnXB`, type: `Identifier` }],
              where: {
          ...
          let [n] = await Z.query(
            {
              ...
              where: {
                left: { name: `UBXOjVnXB`, type: `Identifier` },
                operator: `==`,
                right: { type: `LiteralValue`, value: e },
                type: `BinaryOperation`,
              },
...
export { Q as a, nt as i, tt as n, rt as r, $ as t };
//# sourceMappingURL=ltHWldITw.CSW8-mBS.mjs.map
