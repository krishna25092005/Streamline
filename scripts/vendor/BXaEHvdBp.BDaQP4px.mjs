...
var C,
  ...
  nt = e(() => {
    (t(),
      ...
      (Ge = (e, t, n) => (
        (n = e == null ? {} : w(O(e))),
        M(!t && e && e.__esModule ? n : T(n, `default`, { value: e, enumerable: !0 }), e)
      )),
      (N = (e, t, n) => A(e, typeof t == `symbol` ? t : t + ``, n)),
      (Ke = Ge(
        j({
...
` +
      ...
      (F = class {
        ...
        constructor(e) {
          ((this.bytes = e),
            N(this, `offset`, 0),
            N(this, `view`),
            N(this, `decoder`, new TextDecoder()),
      ...
      (Ye = class {
        ...
        constructor() {
          (N(this, `offset`, 0),
            N(this, `bytes`, new Uint8Array(qe)),
            N(this, `view`, p(this.bytes)),
      ...
      (Xe = class e {
        ...
        constructor(e, t) {
          ((this.fieldNames = e), (this.options = t), N(this, `entries`, []));
        }
      }),
      (H = 3),
      (Ze = 250),
      ...
      (G = class e {
        ...
        constructor() {
          N(this, `fields`, new Map());
        }
      }),
      (et = class {
        scanItems() {
          return (
            (this.itemsPromise ??= U(this.url).then(async (e) => {
      ...
      (tt = class {
        ...
        constructor(e) {
          ((this.options = e),
            ...
            N(this, `schema`),
            N(this, `indexes`),
            N(this, `resolveRichText`),
            N(this, `resolveVectorSetItem`),
            N(this, `chunks`),
      ...
      switch (n[0]) {
        ...
        case 3: {
          ...
          for (let t of s) {
            ...
            let r = e[n];
            r && (rt(r) && r.preload(), (i[t] = r));
          }
          let c = e[r];
          return (
            it(c, `Module not found`),
            rt(c) && c.preload(),
            a(ne, {
  ...
  Tt = e(() => {
    (d(),
      ...
      (q = {
        ...
        Dp3FrT3bt: { isNullable: !0, type: f.String },
        id: { isNullable: !1, type: f.String },
        iUm2cXlVZ: { isNullable: !0, type: f.RichText },
        jUKhJPsSr: { isNullable: !0, type: f.String },
        nextItemId: { isNullable: !0, type: f.String },
        OQuLo0GC3: { isNullable: !0, type: f.ResponsiveImage },
        previousItemId: { isNullable: !0, type: f.String },
        updatedAt: { isNullable: !0, type: f.Date },
        wDT34hbyB: { isNullable: !0, type: f.String },
        yfK91Ahcc: { isNullable: !0, type: f.Date },
        YLoXWzEZu: { isNullable: !0, type: f.String },
      }),
      (lt = [`id`]),
      (J = { type: 1 }),
      (ut = [`previousItemId`]),
      ...
      (Q = {
        collectionByLocaleId: {
          default: new tt({
            chunks: [
              new URL(
                `./BXaEHvdBp-chunk-default-0.framercms`,
                `https://framerusercontent.com/modules/2sHSeAJ4KgN0VNGPfREh/ngLSFMsA9Xvp9h5FzvzP/BXaEHvdBp.js`
              ).href.replace(`/modules/`, `/cms/`),
            ],
            id: `564d8bd5-c5d2-4280-a3b5-899c78a54fcfdefault`,
            indexes: [
              new W({
                collation: J,
                collectionSchema: q,
                ...
                range: { from: 0, to: 193 },
                url: new URL(
                  `./BXaEHvdBp-indexes-default-0.framercms`,
                  `https://framerusercontent.com/modules/2sHSeAJ4KgN0VNGPfREh/ngLSFMsA9Xvp9h5FzvzP/BXaEHvdBp.js`
                ).href.replace(`/modules/`, `/cms/`),
              }),
              new W({
        ...
        displayName: `Blog`,
        id: `564d8bd5-c5d2-4280-a3b5-899c78a54fcf`,
      }),
      u(Q, {
        Dp3FrT3bt: { defaultValue: ``, title: `Title`, type: f.String },
        YLoXWzEZu: { preventLocalization: !1, title: `Slug`, type: f.String },
        wDT34hbyB: { defaultValue: ``, title: `Category`, type: f.String },
        jUKhJPsSr: {
          defaultValue: ``,
          displayTextArea: !0,
        ...
        OQuLo0GC3: { title: `Image`, type: f.ResponsiveImage },
        yfK91Ahcc: { title: `Date`, type: f.Date },
        iUm2cXlVZ: { defaultValue: ``, title: `Content`, type: f.RichText },
        createdAt: { title: `Created`, type: f.Date },
        updatedAt: { title: `Updated`, type: f.Date },
        previousItemId: {
          dataIdentifier: `local-module:collection/BXaEHvdBp:default`,
          title: `Previous`,
          ...
          let [n] = await Z.query(
            {
              ...
              select: [{ name: `YLoXWzEZu`, type: `Identifier` }],
              where: {
          ...
          let [n] = await Z.query(
            {
              ...
              where: {
                left: { name: `YLoXWzEZu`, type: `Identifier` },
                operator: `==`,
                right: { type: `LiteralValue`, value: e },
                type: `BinaryOperation`,
              },
        ...
        exports: {
          ...
          default: {
            ...
            annotations: {
              ...
              framerSlug: `YLoXWzEZu`,
              framerColorSyntax: `false`,
              framerCollectionUtils: `1`,
              framerCollectionId: `BXaEHvdBp`,
...
export { wt as a, Tt as i, $ as n, Ct as r, Q as t };
//# sourceMappingURL=BXaEHvdBp.BDaQP4px.mjs.map
