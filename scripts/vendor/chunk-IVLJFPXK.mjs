...
var l,
  ...
  E =
    (l = String.fromCodePoint) !== null && l !== void 0
      ? l
      : function (u) {
          let e = "";
          return (
...
function v(u) {
  return (u >= f.UPPER_A && u <= f.UPPER_Z) || (u >= f.LOWER_A && u <= f.LOWER_Z) || m(u);
}
function N(u) {
  return u === f.EQUALS || v(u);
}
var b;
(function (u) {
...
var y = class {
  ...
  write(e, a) {
    switch (this.state) {
      case b.EntityStart:
        return e.charCodeAt(a) === f.NUM
          ? ((this.state = b.NumericStart), (this.consumed += 1), this.stateNumericStart(e, a + 1))
          : ((this.state = b.NamedEntity), this.stateNamedEntity(e, a));
      case b.NumericStart:
  ...
  stateNumericStart(e, a) {
    return a >= e.length
      ? -1
      : (e.charCodeAt(a) | w) === f.LOWER_X
        ? ((this.state = b.NumericHex), (this.consumed += 1), this.stateNumericHex(e, a + 1))
        : ((this.state = b.NumericDecimal), this.stateNumericDecimal(e, a));
  }
  addToNumericResult(e, a, c, d) {
    if (a !== c) {
      let r = c - a;
      ((this.result = this.result * Math.pow(d, r) + Number.parseInt(e.substr(a, r), d)),
        (this.consumed += r));
    }
  }
  stateNumericHex(e, a) {
    ...
    for (; a < e.length; ) {
      ...
      if (m(d) || A(d)) a += 1;
      else return (this.addToNumericResult(e, c, a, 16), this.emitNumericEntity(d, 3));
    }
    return (this.addToNumericResult(e, c, a, 16), -1);
  }
  stateNumericDecimal(e, a) {
    ...
    for (; a < e.length; ) {
      let d = e.charCodeAt(a);
      if (m(d)) a += 1;
      else return (this.addToNumericResult(e, c, a, 10), this.emitNumericEntity(d, 2));
    }
    return (this.addToNumericResult(e, c, a, 10), -1);
  }
  emitNumericEntity(e, a) {
    ...
    if (this.consumed <= a)
      return (
        (c = this.errors) === null ||
          c === void 0 ||
          c.absenceOfDigitsInNumericCharacterReference(this.consumed),
        0
      );
    if (e === f.SEMI) this.consumed += 1;
    else if (this.decodeMode === s.Strict) return 0;
    return (
      this.emitCodePoint(n(this.result), this.consumed),
      this.errors &&
        (e !== f.SEMI && this.errors.missingSemicolonAfterCharacterReference(),
  ...
  stateNamedEntity(e, a) {
    let { decodeTree: c } = this,
      d = c[this.treeIndex],
      r = (d & o.VALUE_LENGTH) >> 14;
    for (; a < e.length; a++, this.excess++) {
      let t = e.charCodeAt(a);
      if (((this.treeIndex = L(c, d, this.treeIndex + Math.max(1, r), t)), this.treeIndex < 0))
        return this.result === 0 || (this.decodeMode === s.Attribute && (r === 0 || N(t)))
          ? 0
          : this.emitNotTerminatedNamedEntity();
      if (((d = c[this.treeIndex]), (r = (d & o.VALUE_LENGTH) >> 14), r !== 0)) {
        if (t === f.SEMI)
  ...
  emitNotTerminatedNamedEntity() {
    var e;
    let { result: a, decodeTree: c } = this,
      d = (c[a] & o.VALUE_LENGTH) >> 14;
    return (
      this.emitNamedEntityData(a, d, this.consumed),
      (e = this.errors) === null || e === void 0 || e.missingSemicolonAfterCharacterReference(),
      this.consumed
    );
  }
  emitNamedEntityData(e, a, c) {
    let { decodeTree: d } = this;
    return (
      this.emitCodePoint(a === 1 ? d[e] & ~o.VALUE_LENGTH : d[e + 1], c),
      a === 3 && this.emitCodePoint(d[e + 2], c),
      c
    );
  }
  end() {
    ...
    switch (this.state) {
      case b.NamedEntity:
        return this.result !== 0 &&
          (this.decodeMode !== s.Attribute || this.result === this.treeIndex)
          ? this.emitNotTerminatedNamedEntity()
          : 0;
      case b.NumericDecimal:
...
function L(u, e, a, c) {
  let d = (e & o.BRANCH_LENGTH) >> 7,
    r = e & o.JUMP_TABLE;
  if (d === 0) return r !== 0 && c === r ? a : -1;
  if (r) {
    let i = c - r;
    return i < 0 || i >= d ? -1 : u[a + i] - 1;
  }
  let t = a,
    x = t + d - 1;
  for (; t <= x; ) {
...
export { p as a, g as b, E as c, s as d, y as e };
//# sourceMappingURL=chunk-IVLJFPXK.mjs.map
