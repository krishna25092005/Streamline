...
import { C as p, a as m, r as ne, t as re } from "./motion.BvGXTKSj.mjs";
import {
  A as h,
  D as g,
  E as ie,
  ...
  me = e(() => {
    (d(),
      ...
      (N = c((e, t) => {
        ...
        return n ? l(p.div, { ...a, layoutId: r, ref: t }) : l(`div`, { ...a, ref: t });
      })),
...
e(() => {
  (d(),
    ...
    (W = v(U)),
    (G = v(F)),
    (K = C(F, { nodeId: `pBR1Ew0r8`, override: fe, scopeId: `PX9hIOIVM` })),
    (q = x(ae(C(p.a, { nodeId: `HK2sXlagE`, override: de, scopeId: `PX9hIOIVM` })))),
    (J = `framer-6jWyo`),
    ...
    (ye = ({ value: e, children: t }) => {
      ...
      return l(m.Provider, { value: i, children: t });
    }),
    (be = p.create(i)),
    ...
    (Q = y(
      c(function (e, t) {
        ...
        ce();
        let { style: s, className: c, layoutId: d, variant: f, ...m } = xe(e),
          {
            baseVariant: re,
            classNames: g,
            ...
            setVariant: b,
            variants: x,
          } = le({ defaultVariant: `HK2sXlagE`, ref: r, variant: f, variantClassNames: Y }),
          S = Se(e, x),
          C = h(J);
        return l(ne, {
          id: d ?? i,
            ...
            children: l(ye, {
              ...
              children: l(se, {
                ...
                children: u(q, {
                  ...
                  __targetOpacity: 1,
                  className: `${h(C, `framer-n0ccwk`, c, g)} framer-bmpgw8`,
...
//# sourceMappingURL=PX9hIOIVM.DWBO4CpL.mjs.map
