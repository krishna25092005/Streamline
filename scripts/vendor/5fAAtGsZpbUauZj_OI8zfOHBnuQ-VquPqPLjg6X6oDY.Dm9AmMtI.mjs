...
function r(e, n) {
  return {
    breakpoints: [
      { hash: `1akvc4q`, mediaQuery: `(min-width: 1200px)` },
      { hash: `1c9fhsj`, mediaQuery: `(min-width: 810px) and (max-width: 1199.98px)` },
      { hash: `b2yb0a`, mediaQuery: `(max-width: 809.98px)` },
    ],
    description: t(e, n).description,
    elements: {},
    framerSearch: { index: !1 },
    robots: `noindex`,
    serializationId: `framer-nPwi2`,
    socialImage: `https://framerusercontent.com/assets/XrDkrt4yFMIFJfRnydBqiTfMnk.jpg`,
    title: t(e, n).title || `404`,
...
//# sourceMappingURL=5fAAtGsZpbUauZj_OI8zfOHBnuQ-VquPqPLjg6X6oDY.Dm9AmMtI.mjs.map
