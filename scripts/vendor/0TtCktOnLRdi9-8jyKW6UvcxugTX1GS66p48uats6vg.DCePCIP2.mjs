...
function r(e, n) {
  return {
    breakpoints: [
      { hash: `v5vaby`, mediaQuery: `(min-width: 1200px)` },
      { hash: `4m7kpo`, mediaQuery: `(min-width: 810px) and (max-width: 1199.98px)` },
      { hash: `d14ofi`, mediaQuery: `(max-width: 809.98px)` },
    ],
    description: t(e, n).description,
    elements: {},
    robots: `max-image-preview:large`,
    serializationId: `framer-liUu8`,
...
//# sourceMappingURL=0TtCktOnLRdi9-8jyKW6UvcxugTX1GS66p48uats6vg.DCePCIP2.mjs.map
