...
- Know about the [Payment Flow](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/how-it-works.md) and follow these integration steps:
...
### 1.1 Instantiate Razorpay
     ...
     var instance = new Razorpay({
       key_id: 'rzp_test_TGgxLLNb4O1mL6',
       key_secret: '5Q0NJzdEpHyr9Iu0rwve1PRv',
     });
     ```
...
### 1.2 Create an Order in Server
     ...
     - You can create an order using the [Orders API](#api-sample-code) in the **app.js** file. It is a server-side API call.  Know how to [authenticate](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys) Orders API.  
...
You can capture payments automatically with one-time [Payment Capture setting configuration](https://razorpay.com/docs/build/llm-docs/payments/server-integration/nodejs/integration-steps.md#3-go-live-checklist) on the Dashboard.
...
: `string` The currency in which the transaction should be made. See the [list of supported currencies](https://razorpay.com/docs/build/llm-docs/payments/international-payments.md#supported-currencies). Length must be 3 characters.
...
### 1.2.3 Response Parameters
            ...
            Descriptions for the response parameters are present in the [Orders Entity](https://razorpay.com/docs/build/llm-docs/api/orders/entity.md) table.
          

       
### 1.2.4 Error Response Parameters

            The error response parameters are available in the [API Reference Guide](https://razorpay.com/docs/build/llm-docs/api/orders.md#error-response-parameters).
...
You can also integrate the Razorpay Checkout with [React.js](https://razorpay.com/docs/build/llm-docs/payments/server-integration/nodejs/troubleshooting-faqs.md#3-can-i-integrate-razorpay-checkout-with-reactjs) using the sample code.
...
Test the integration using these [test cards](https://razorpay.com/docs/build/llm-docs/payments/server-integration/nodejs/integration-steps.md#2-test-integration).
...
- Autofill customer contact details, especially phone number to ease form completion. Include customerâ€™s phone number in the `contact` parameter of the JSON request's `prefill` object. Format: +(country code)(phone number). Example: "contact": "+919000090000".   
...
### 1.3.5 Configure Payment Methods *(Optional)*
          ...
          - You can configure the order or make certain payment methods prominent. Know more about configuring payment methods. Know more about [configuring payment methods](https://razorpay.com/docs/build/llm-docs/payments/payment-gateway/web-integration/standard/configure-payment-methods.md).
...
### 1.5 Verify Payment Signature
     ...
     1. Create a signature in your server using the following attributes:
        ...
        ---
        `key_secret` | Available in your server. The `key_secret` that was generated from the  [Dashboard](https://razorpay.com/docs/build/llm-docs/api/authentication.md#generate-api-keys).  
...
On the Dashboard, ensure that the payment status is `captured`. Refer to the payment capture settings page to know how to [capture payments automatically](https://razorpay.com/docs/build/llm-docs/payments/payments/capture-settings.md).
     ...
     You can track the payment status in three ways:
          ...
          1. Log in to the Dashboard and navigate to **Transactions** â†’ **Payments**.
          ...
          [Poll Payment APIs](https://razorpay.com/docs/build/llm-docs/api/payments.md#fetch-multiple-payments) to check the payment status.
...
---
[Debit Card](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/cards.md) | `debit` | âœ“
---
[Credit Card](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/cards.md) | `credit` | âœ“
---
[Netbanking](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/netbanking.md) | `netbanking`| âœ“
---
[UPI](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/upi.md) | `upi` | âœ“
---
EMI - [Credit Card EMI](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi/credit-card-emi.md), [Debit Card EMI](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi/debit-card-emi.md) and [No Cost EMI](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/emi/no-cost-emi.md) | `emi` | âœ“
---
[Wallet](https://razorpay.com/docs/build/llm-docs/payments/payment-methods/wallets.md) | `wallet` | âœ“
---
...
1. Navigate to **Account & Settings** â†’ **API Keys** â†’ **Generate Key** to generate the API Key for Live Mode.
...
Razorpay offers a range of [payment products](https://razorpay.com/docs/build/llm-docs/payments.md) to meet your business requirements. Visit our  [GitHub repository](https://github.com/razorpay/razorpay-node) for the sample codes.
...
[Troubleshooting and FAQs](https://razorpay.com/docs/build/llm-docs/payments/server-integration/nodejs/troubleshooting-faqs.md)